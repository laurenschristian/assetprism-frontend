...
import { useCreateSoftwareLicense } from '@/hooks/use-software-licenses';
import type { 
...
export function CreateLicenseDialog({ open, onOpenChange }: CreateLicenseDialogProps) {
  ...
  const createLicenseMutation = useCreateSoftwareLicense();
  ...
  const onSubmit = async (data: LicenseFormData) => {
    ...
    try {
      ...
      const licenseData: CreateSoftwareLicenseRequest = {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Register a new software license in your asset inventory.
          </DialogDescription>
        </DialogHeader>
